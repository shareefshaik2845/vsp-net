...
abstract class IStaffRepository {
  ...
  Future<void> updateHousekeepingStatus(String roomId, String status, {String? assignedStaff, String? notes});
  ...
  Future<List<Map<String, dynamic>>> fetchTasks(String propertyId, {String? status, String? date});
