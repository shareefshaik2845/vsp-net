...
abstract class ICustomerRepository {
  Future<List<Map<String, dynamic>>> fetchProperties({String? search, String? state, String? city, String? category});
  ...
  Future<Map<String, dynamic>> validateCoupon(String code, double subtotal, String propertyId);
  Future<List<Map<String, dynamic>>> fetchAvailableCoupons();
  Future<List<Booking>> fetchBookings({String? status, int page = 1, int pageSize = 20});
  ...
  Future<List<Map<String, dynamic>>> fetchCalendarBlocks(String propertyId, String from, String to);
  Future<Map<String, dynamic>> fetchAvailability(String propertyId, String from, String to);
  Future<Map<String, dynamic>> fetchMonthlyCalendar(String propertyId, int month, int year);
  Future<Map<String, dynamic>> fetchPaymentForBooking(String bookingId);
  Future<List<Map<String, dynamic>>> fetchConciergeRequests();
  Future<List<Map<String, dynamic>>> fetchInvoices({String? status, int page = 1, int pageSize = 20});
