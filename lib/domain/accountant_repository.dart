...
abstract class IAccountantRepository {
  ...
  Future<Map<String, dynamic>> downloadLedgerPdf(String propertyId, String from, String to);
  Future<Map<String, dynamic>> downloadLedgerExcel(String propertyId, String from, String to);
